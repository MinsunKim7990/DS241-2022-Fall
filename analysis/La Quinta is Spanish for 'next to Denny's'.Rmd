...
-mean and median
-choose some arbitrary distance, and compare what percentage of each fast food restaurant is within that distance to La Quinta - visualize with pie chart
-stacked histogram
-boxplot

Visualization Ideas from Gallery:
-boxplot or violin for mindist
-heatmap from location to ? - or connection map
-density plot (mirror)

Look at data that is actually close (top %) to not be skewed.